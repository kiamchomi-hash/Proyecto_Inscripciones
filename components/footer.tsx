      ...
      <div className="container mx-auto px-6 py-14">
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
          ...
          <div className="flex items-center gap-3">
            <a href="https://wa.me/5491166522722?text=Hola%2C%20me%20gustar%C3%ADa%20realizar%20una%20consulta" target="_blank" rel="noopener" aria-label="WhatsApp"
              className="flex items-center justify-center w-10 h-10 rounded-lg text-white transition-all hover:scale-105 hover:brightness-125"
              style={{ background: 'rgba(37, 211, 102, 0.22)', border: '1px solid rgba(37, 211, 102, 0.65)' }}>
            ...
            <a href="https://www.facebook.com/ceducativovillalugano/" target="_blank" rel="noopener" aria-label="Facebook"
              className="flex items-center justify-center w-10 h-10 rounded-lg text-white transition-all hover:scale-105 hover:brightness-125"
              style={{ background: 'rgba(24, 119, 242, 0.22)', border: '1px solid rgba(24, 119, 242, 0.65)' }}>
            ...
            <a href="https://www.instagram.com/centroeducativovillalugano/" target="_blank" rel="noopener" aria-label="Instagram"
              className="flex items-center justify-center w-10 h-10 rounded-lg text-white transition-all hover:scale-105 hover:brightness-125"
              style={{ background: 'rgba(214, 36, 159, 0.22)', border: '1px solid rgba(214, 36, 159, 0.65)' }}>
