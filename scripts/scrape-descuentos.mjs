...
const NOMBRE_MAP = {
  ...
  'Lic Gtión de RRHH': 'Gestión de Recursos Humanos',
  ...
  'Tec Ad y G Pol Pb': 'Administración y Gestión de Políticas Públicas',
  'Tec Adm y Gt Trib': 'Administración y Gestión Tributaria',
  'Tec Clima Laboral': 'Gestión del Clima Laboral de la Organización',
  'Tec Dir Equip Vts': 'Dirección de Equipos de venta',
  'Tec Dis Animc Dig': 'Diseño y Animación Digital',
  'Tec Ges Emp Fliar': 'Gestión de Empresas Familiares',
  'Tec Ges y Aud Amb': 'Gestión y Auditorías Ambientales',
  'Tec Gest Cble Imp': 'Gestión Contable e impositiva',
  'Tec Gst ServSalud': 'Gestión Administrativa de Servicios de Salud',
  'Tec Gtión de Moda': 'Gestión de Moda',
  'Tec Gtión RR Tur': 'Recursos Turísticos',
  'Tec HyS Laboral': 'Higiene y Seguridad Laboral',
  'Tec Inv Esc Crime': 'Investigación de la escena del crimen',
  'Tec Mart. Público': 'Martillero, Corredor Público y Corredor Inmobiliario',
  'Tec Mkt Dig y Pub': 'Marketing y Publicidad Digital',
  'Tec Pcolo Evtos': 'Dirección de Protocolo, Organización de Eventos y RRPP',
  'Tec Pro. Com. NyA': 'Promoción Comunitaria en Niñez y Adolescencia',
  'Tec Redes Inf y Telec': 'Redes Informáticas y Telecomunicaciones',
  'Tec Relac Lborals': 'Relaciones Laborales',
  'Tec Resp Gest Soc': 'Responsabilidad y Gestión Social',
  'Tec. Adm. Prop. Horiz.': 'Tecnicatura Universitaria en Administración de la Propiedad Horizontal y Conjuntos Inmobiliarios',
  'Tec. Dño. y Drrllo. Videojuegos': 'Diseño y Desarrollo de Videojuegos',
  'Tec. Hidro. y Geo': 'Hidrocarburos y Geociencias',
  'Tec. Negoc. Agroecol.': 'Negocios Agroecológicos',
};
